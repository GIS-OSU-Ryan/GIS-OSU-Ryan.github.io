...
//Update the info based on what county user has clicked on
info.update = function (props) {
    this._div.innerHTML = '<h4>Ohio Diverstiy Rank</h4>' + (props ?
        '<b>' + props.name + '</b><br />' + props.divrank + ' / mi<sup>2</sup>'
        : 'Hover over county for rank ');
};
